...
namespace ProtocolCraft
{
    ...
    {
    public:
        static std::shared_ptr<Message> CreateMessageClientbound(const int id, const int state)
        {
            switch (state)
            {
            case -1: // None
        ...
        static std::shared_ptr<Message> CreateMessageServerbound(const int id, const int state)
        {
            switch (state)
            {
            case -1: // None
