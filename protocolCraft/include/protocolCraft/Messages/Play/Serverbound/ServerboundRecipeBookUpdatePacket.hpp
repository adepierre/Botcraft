...
namespace ProtocolCraft
{
    ...
    public:
        ...
        DECLARE_FIELDS(
            (Internal::Conditioned<VarInt, &ServerboundRecipeBookUpdatePacket::Purpose0>, Internal::Conditioned<Identifier, &ServerboundRecipeBookUpdatePacket::Purpose0>, Internal::Conditioned<bool, &ServerboundRecipeBookUpdatePacket::Purpose1>, Internal::Conditioned<bool, &ServerboundRecipeBookUpdatePacket::Purpose1>),
            (Purpose,                                                                     Recipe,                                                                          GuiOpen,                                                                   FilteringCraftable)
        );
#elif PROTOCOL_VERSION < 477 /* < 1.14 */
        DECLARE_FIELDS(
            (Internal::Conditioned<VarInt, &ServerboundRecipeBookUpdatePacket::Purpose0>, Internal::Conditioned<Identifier, &ServerboundRecipeBookUpdatePacket::Purpose0>, Internal::Conditioned<bool, &ServerboundRecipeBookUpdatePacket::Purpose1>, Internal::Conditioned<bool, &ServerboundRecipeBookUpdatePacket::Purpose1>, Internal::Conditioned<bool, &ServerboundRecipeBookUpdatePacket::Purpose1>, Internal::Conditioned<bool, &ServerboundRecipeBookUpdatePacket::Purpose1>),
