...
- ⚠️ For 1.19+, botcraft can only connect to servers with property enforce-secure-profile set to false. Connection to servers with enforce-secure-profile=true is not supported (yet, see secure_profile branch if you're curious to see how it's going). ⚠️
