...
namespace Botcraft
{
    namespace Renderer
    {
                ...
                }
                {
                    ...
                    std::shared_ptr<Blockstate> raycasted_blockstate;
                    {
                        ...
                        raycasted_blockstate =
                            world->Raycast(Vector3<double>(camera->GetPosition().x, camera->GetPosition().y, camera->GetPosition().z),
        ...
        void RenderingManager::UpdateChunk(const int x_, const int z_, const std::shared_ptr<const Botcraft::Chunk> chunk)
        {
        ...
        void RenderingManager::AddFace(const int x_, const int y_, const int z_, const Face &face_,
        ...
        const std::vector<unsigned int> RenderingManager::GetColorModifier(const int y, const std::shared_ptr<Biome> biome, const std::shared_ptr<Blockstate> blockstate, const std::vector<bool> &use_tintindex) const
        {
